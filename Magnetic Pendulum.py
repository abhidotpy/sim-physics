"""
Python program to simulate the magnetic pendulum fractal
"""
...
def f(x0: List[Any], t0, K=1, b=0.1, KM=1, e=0.2):
    """
...
N = 200                             # No of integration points
...
P_mag = np.array([[R * np.cos(d), R * np.sin(d)]\
                  for d in np.radians([-30, -150, -270])])  # Magnet positions
